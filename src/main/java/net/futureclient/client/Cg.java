...
extends Ha<jf> {
    ...
    public void f$E(jf jf2) {
        if (jf2.f$E() instanceof SPacketPlayerPosLook) {
            ...
            if (!Ie.f$H().player.func_70089_S() || !Ie.f$B().world.func_175668_a(new BlockPos(Ie.f$h().player.field_70165_t, Ie.f$A().player.field_70163_u, Ie.f$K().player.field_70161_v), false) || Ie.f$e().currentScreen instanceof GuiDownloadTerrain || ((tE)((Object)Ie.f$a(this.f$d).f$E())).equals((Object)tE.f$i) || (v = Ie.f$E(this.f$d).remove(sPacketPlayerPosLook.getTeleportId())) != null) {
                // empty if block
            }
            ((I)sPacketPlayerPosLook).setYaw(Ie.f$a().player.field_70177_z);
            ((I)sPacketPlayerPosLook).setPitch(Ie.f$E().player.field_70125_A);
            Ie.f$E(this.f$d, sPacketPlayerPosLook.getTeleportId());
        }
    }
